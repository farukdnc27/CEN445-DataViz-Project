    ...
    with tab3:
        ...
        st.info("""
            **İlgili Sorular:**
            ...
            - Manhattan’da Entire home baskın mı?
            - Brooklyn’de Private room yoğun mu?
            - Queens’de Shared room oranı düşük mü?
        """)
        ...
        with col6:
            ...
            if df_sankey.empty:
                ...
                if grouped.empty:
                    ...
                    st.markdown(
                        f"**Total Flows:** {len(values):,} | "
                        f"**Total Listings (after filters):** {len(df_sankey):,}")
